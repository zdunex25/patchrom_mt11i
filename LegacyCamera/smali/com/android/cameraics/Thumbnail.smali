.class public Lcom/android/cameraics/Thumbnail;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/cameraics/Thumbnail$Media;
    }
.end annotation
...
.method public constructor <init>(Landroid/net/Uri;Landroid/graphics/Bitmap;I)V
    ...
    iput-boolean v0, p0, Lcom/android/cameraics/Thumbnail;->mFromFile:Z

    .line 57
    iput-object p1, p0, Lcom/android/cameraics/Thumbnail;->mUri:Landroid/net/Uri;

    .line 58
    invoke-static {p2, p3}, Lcom/android/cameraics/Thumbnail;->rotateImage(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;

    move-result-object v0

    iput-object v0, p0, Lcom/android/cameraics/Thumbnail;->mBitmap:Landroid/graphics/Bitmap;

    .line 59
    iget-object v0, p0, Lcom/android/cameraics/Thumbnail;->mBitmap:Landroid/graphics/Bitmap;
...
.method private static createThumbnail(Landroid/net/Uri;Landroid/graphics/Bitmap;I)Lcom/android/cameraics/Thumbnail;
    .locals 4
    .parameter "uri"
    .parameter "bitmap"
    .parameter "orientation"
    ...
    :cond_0
    :try_start_0
    new-instance v2, Lcom/android/cameraics/Thumbnail;

    invoke-direct {v2, p0, p1, p2}, Lcom/android/cameraics/Thumbnail;-><init>(Landroid/net/Uri;Landroid/graphics/Bitmap;I)V
    :try_end_0
...
.method public static createThumbnail([BIILandroid/net/Uri;)Lcom/android/cameraics/Thumbnail;
    .locals 4
    .parameter "jpeg"
    .parameter "orientation"
    ...
    invoke-static {p3, v0, p1}, Lcom/android/cameraics/Thumbnail;->createThumbnail(Landroid/net/Uri;Landroid/graphics/Bitmap;I)Lcom/android/cameraics/Thumbnail;
...
.method public static createVideoThumbnail(Ljava/io/FileDescriptor;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, p0, p1}, Lcom/android/cameraics/Thumbnail;->createVideoThumbnail(Ljava/lang/String;Ljava/io/FileDescriptor;I)Landroid/graphics/Bitmap;
...
.method public static createVideoThumbnail(Ljava/lang/String;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v0, p1}, Lcom/android/cameraics/Thumbnail;->createVideoThumbnail(Ljava/lang/String;Ljava/io/FileDescriptor;I)Landroid/graphics/Bitmap;
...
.method public static getLastImageThumbnail(Landroid/content/ContentResolver;)Lcom/android/cameraics/Thumbnail$Media;
    .locals 15
    .parameter "resolver"
    ...
    .line 195
    sget-object v4, Lcom/android/cameraics/Storage;->BUCKET_ID:Ljava/lang/String;
    ...
    .line 203
    .local v7, id:J
    new-instance v6, Lcom/android/cameraics/Thumbnail$Media;
    ...
    .line 203
    invoke-direct/range {v6 .. v12}, Lcom/android/cameraics/Thumbnail$Media;-><init>(JIJLandroid/net/Uri;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static getLastThumbnail(Landroid/content/ContentResolver;)Lcom/android/cameraics/Thumbnail;
    .locals 10
    .parameter "resolver"
    ...
    .line 149
    invoke-static {p0}, Lcom/android/cameraics/Thumbnail;->getLastImageThumbnail(Landroid/content/ContentResolver;)Lcom/android/cameraics/Thumbnail$Media;

    move-result-object v1

    .line 150
    .local v1, image:Lcom/android/cameraics/Thumbnail$Media;
    invoke-static {p0}, Lcom/android/cameraics/Thumbnail;->getLastVideoThumbnail(Landroid/content/ContentResolver;)Lcom/android/cameraics/Thumbnail$Media;

    move-result-object v3

    .line 151
    .local v3, video:Lcom/android/cameraics/Thumbnail$Media;
    if-nez v1, :cond_1
    ...
    iget-wide v5, v1, Lcom/android/cameraics/Thumbnail$Media;->dateTaken:J

    iget-wide v7, v3, Lcom/android/cameraics/Thumbnail$Media;->dateTaken:J
    ...
    .line 158
    :cond_2
    iget-wide v5, v1, Lcom/android/cameraics/Thumbnail$Media;->id:J
    ...
    .line 168
    .local v2, lastMedia:Lcom/android/cameraics/Thumbnail$Media;
    :goto_1
    iget-object v5, v2, Lcom/android/cameraics/Thumbnail$Media;->uri:Landroid/net/Uri;

    invoke-static {v5, p0}, Lcom/android/cameraics/Util;->isUriValid(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    .line 169
    iget-object v4, v2, Lcom/android/cameraics/Thumbnail$Media;->uri:Landroid/net/Uri;

    iget v5, v2, Lcom/android/cameraics/Thumbnail$Media;->orientation:I

    invoke-static {v4, v0, v5}, Lcom/android/cameraics/Thumbnail;->createThumbnail(Landroid/net/Uri;Landroid/graphics/Bitmap;I)Lcom/android/cameraics/Thumbnail;
    ...
    .line 162
    .end local v2           #lastMedia:Lcom/android/cameraics/Thumbnail$Media;
    :cond_3
    iget-wide v5, v3, Lcom/android/cameraics/Thumbnail$Media;->id:J
    ...
    .restart local v2       #lastMedia:Lcom/android/cameraics/Thumbnail$Media;
    goto :goto_1
.end method

.method private static getLastVideoThumbnail(Landroid/content/ContentResolver;)Lcom/android/cameraics/Thumbnail$Media;
    .locals 15
    .parameter "resolver"
...
.method public static loadFrom(Ljava/io/File;)Lcom/android/cameraics/Thumbnail;
    .locals 13
    .parameter "file"
    ...
    .line 139
    invoke-static {v7}, Lcom/android/cameraics/Util;->closeSilently(Ljava/io/Closeable;)V

    .line 140
    invoke-static {v1}, Lcom/android/cameraics/Util;->closeSilently(Ljava/io/Closeable;)V

    .line 141
    invoke-static {v4}, Lcom/android/cameraics/Util;->closeSilently(Ljava/io/Closeable;)V

    .line 143
    const/4 v10, 0x0

    invoke-static {v9, v2, v10}, Lcom/android/cameraics/Thumbnail;->createThumbnail(Landroid/net/Uri;Landroid/graphics/Bitmap;I)Lcom/android/cameraics/Thumbnail;

    move-result-object v8

    .line 144
    .local v8, thumbnail:Lcom/android/cameraics/Thumbnail;
    if-eqz v8, :cond_0

    const/4 v10, 0x1

    invoke-virtual {v8, v10}, Lcom/android/cameraics/Thumbnail;->setFromFile(Z)V
    ...
    .end local v8           #thumbnail:Lcom/android/cameraics/Thumbnail;
    ...
    .line 140
    invoke-static {v0}, Lcom/android/cameraics/Util;->closeSilently(Ljava/io/Closeable;)V

    .line 141
    invoke-static {v3}, Lcom/android/cameraics/Util;->closeSilently(Ljava/io/Closeable;)V
...
.method public fromFile()Z
    ...
    .prologue
    .line 75
    iget-boolean v0, p0, Lcom/android/cameraics/Thumbnail;->mFromFile:Z
...
.method public getUri()Landroid/net/Uri;
    ...
    .prologue
    .line 63
    iget-object v0, p0, Lcom/android/cameraics/Thumbnail;->mUri:Landroid/net/Uri;
...
.method public saveTo(Ljava/io/File;)V
    ...
    :try_start_3
    iget-object v7, p0, Lcom/android/cameraics/Thumbnail;->mUri:Landroid/net/Uri;
    ...
    .line 109
    iget-object v7, p0, Lcom/android/cameraics/Thumbnail;->mBitmap:Landroid/graphics/Bitmap;
    ...
    .line 114
    invoke-static {v5}, Lcom/android/cameraics/Util;->closeSilently(Ljava/io/Closeable;)V
...
.method public setFromFile(Z)V
    ...
    .prologue
    .line 71
    iput-boolean p1, p0, Lcom/android/cameraics/Thumbnail;->mFromFile:Z
