...
then
	...
	sed -i -e 's/http:\/\/www.miui.com\/res\/doc\/manual.html?lang=%s&miphone=%s/http:\/\/91.205.75.29\/manual\/user_manual_%s\/%s\/index.html/' $BUILD_OUT/framework2/smali/com/miui/internal/app/MiuiLicenseActivity.smali
fi
